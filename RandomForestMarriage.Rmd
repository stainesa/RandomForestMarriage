...
It's possible, and desirable, to simplify these trees, and a complexity penalty can be provided in the model for overly complex trees. This is set at 0.01, by default, but choosing to reduce it to 0.03, a modest change, produces a very different, and perhaps more comprehensible, picture.
